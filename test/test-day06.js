...
describe('Day 6', function() {
  ...
  describe('Part One', function() {
    ...
    it('should return 0 when input is "toggle 0,0 through 999,0"', function () {
    ...
    it('should return 0 when input is "turn on 499,499 through 500,500"', function () {
      assert.equal( 4, day6part1(['turn on 499,499 through 500,500']) );
    });
  ...
  describe('Part Two', function() {
    ...
    it('should return 0 when input is "toggle 0,0 through 999,999"', function () {
      assert.equal( 2000000, day6part2(['toggle 0,0 through 999,999']) );
    });

    it('should return 0 when input is "turn on 0,0 through 0,0"', function () {
